 ...
 * Replaces the hand-inlined `viewBox="0 0 100 124"` copies in Header, Footer, MobileNav,
 * VelLoader, AuthModal and checkout.
 *
 * The V is a full capital: ink fills the viewBox, ink height == the wordmark's cap height,
 * and the row is aligned on the BASELINE (items-baseline), not the line box. See docs/BRAND.md.
 *
 * Path: src/view/primitives/Wordmark.tsx
 */
