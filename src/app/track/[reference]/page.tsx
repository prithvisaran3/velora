      ...
      {!isVerified ? (
        <div className="max-w-[480px] mx-auto px-6 py-20 flex flex-col gap-6 text-center">
          <div className="flex flex-col gap-2">
            <span className="font-sans text-[11px] tracking-[0.3em] uppercase text-[#E8621B] font-bold">
              SECURITY VERIFICATION
            </span>
            <h1 className="font-display text-[38px] text-[#241F1C]">Track Order {order.reference}</h1>
            <p className="font-sans text-[13px] text-[#241F1C]/75 leading-[1.6]">
              To protect customer privacy, please enter the last 4 digits of the mobile number registered with this order.
            </p>
          </div>

          <form onSubmit={handleVerify} className="flex flex-col gap-4 bg-white p-6 border border-[#241F1C]/15">
            <input
              type="text"
              maxLength={4}
              required
              ...
              className="w-full border border-[#241F1C]/30 p-3 text-center font-mono text-[20px] text-[#241F1C] tracking-widest bg-transparent focus:outline-none focus:border-[#E8621B]"
            />
            {errorMsg && <span className="font-sans text-[11px] text-[#B4470F]">{errorMsg}</span>}
            <Button variant="primary" type="submit" className="py-4 text-[11px]">
        ...
        <div className="max-w-[1440px] mx-auto px-8 md:px-[64px] py-[64px] flex flex-col gap-[44px]">
          ...
          {/* Order Summary Box */}
          <div className="bg-[#F6EAD6] p-6 border border-[#241F1C]/15 flex flex-col gap-3">
            <span className="font-sans text-[10px] tracking-[0.26em] uppercase text-[#B4470F] font-bold">
              ORDER SUMMARY
            </span>
            ...
            <span className="font-sans text-[11px] text-[#241F1C]/70">
