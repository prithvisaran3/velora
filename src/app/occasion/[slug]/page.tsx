  ...
  return (
    <div className="w-full bg-[#FDF4E4] min-h-screen flex flex-col">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-[64px] py-14 flex flex-col gap-4">
        <h1 className="font-display text-[52px] md:text-[76px] leading-[0.98] text-[#241F1C]">
          Six moments
        </h1>
        <p className="font-sans text-[15px] leading-[1.75] text-[#241F1C]/78 max-w-[560px]">
      ...
      <div className="w-full border-t border-[#241F1C]/12 flex flex-col md:flex-row items-stretch">
        <div className="w-full md:w-[520px] h-[320px] md:h-[420px] placeholder-weave flex items-end p-4 border-b md:border-b-0 md:border-r border-[#241F1C]/12 flex-shrink-0">
          <span className="font-mono text-[10px] text-[#241F1C]/60">muhurtham · bride, morning light</span>
        </div>
        <div className="flex-1 p-8 md:p-[56px] flex flex-col justify-center gap-4">
          <span className="font-sans text-[11px] tracking-[0.3em] uppercase text-[#B4470F]">
            01 · MUHURTHAM
          </span>
          <h2 className="font-display text-[36px] md:text-[52px] leading-[1.05] text-[#241F1C]">
            The morning she is given away
          </h2>
          <p className="font-sans text-[14px] leading-[1.75] text-[#241F1C]/78 max-w-[520px]">
      ...
      <div className="w-full border-t border-[#241F1C]/12 flex flex-col md:flex-row-reverse items-stretch">
        <div className="w-full md:w-[520px] h-[320px] md:h-[420px] placeholder-weave flex items-end p-4 border-b md:border-b-0 md:border-l border-[#241F1C]/12 flex-shrink-0">
          <span className="font-mono text-[10px] text-[#241F1C]/60">temple · corridor, oil lamp</span>
        </div>
        <div className="flex-1 p-8 md:p-[56px] flex flex-col justify-center gap-4">
          <span className="font-sans text-[11px] tracking-[0.3em] uppercase text-[#B4470F]">
            03 · TEMPLE
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-[64px] py-12 w-full border-t border-[#241F1C]/12">
        <h3 className="font-display text-[32px] text-[#241F1C] mb-6">
