    ...
    <div className="max-w-[840px] mx-auto px-6 md:px-16 py-12 w-full min-h-screen flex flex-col">
      ...
      {cartCount === 0 ? (
        ...
        <div className="flex flex-col gap-8 mt-8">
          <div className="flex flex-col gap-6 divide-y divide-[#241F1C]/15">
            {cartItems.map((item) => (
              <div key={item.id} className="pt-6 flex items-start justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="relative w-[80px] h-[106px] placeholder-weave border border-[#241F1C]/10 overflow-hidden flex-shrink-0">
                    <Image src={item.images[0]?.id || "/brand/png/icon-flat-512.png"} alt={item.title.en} fill className="object-cover" />
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="font-sans text-[9px] uppercase tracking-[0.2em] text-[#B4470F] font-medium">
                    ...
                    <button
                      ...
                      className="font-sans text-[11px] text-[#B4470F] underline text-left mt-2"
                    >
                      Remove
                    </button>
                  </div>
          ...
          <div className="border-t border-[#241F1C]/20 pt-6 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between font-sans text-[14px]">
              ...
              <span className="text-[#E8621B] font-medium uppercase text-[12px] tracking-wider">FREE</span>
            </div>
            <div className="flex items-center justify-between font-display text-[22px] text-ink pt-2 border-t border-[#241F1C]/15">
